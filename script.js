document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("Kaja Beauty", 20, y); y += lineHeight;
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:kaja.collaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(bodyPlain)}`;
